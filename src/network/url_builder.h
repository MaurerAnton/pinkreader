 ...
 *
 * File: url_builder.h
 * Description: URL construction for Reddit API endpoints
 */
...
/**
 * @brief URL construction for Reddit API endpoints
 *
 * @note Part of the PinkReader network layer
 */
class UrlBuilder : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit UrlBuilder(QObject *parent = nullptr);
    ~UrlBuilder() override;
