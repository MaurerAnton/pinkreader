 ...
 * ... (full GPLv3 license) ...
 *
 * File: streamable_api.h
 * Description: Streamable.com video support
 */
...
/**
 * @brief Streamable.com video support
 */
class StreamableApi : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit StreamableApi(QObject *parent = nullptr);
    ~StreamableApi() override;
