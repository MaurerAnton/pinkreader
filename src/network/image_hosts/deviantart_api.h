 ...
 * ... (full GPLv3 license) ...
 *
 * File: deviantart_api.h
 * Description: DeviantArt image support
 */
...
/**
 * @brief DeviantArt image support
 */
class DeviantartApi : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit DeviantartApi(QObject *parent = nullptr);
    ~DeviantartApi() override;
