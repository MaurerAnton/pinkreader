 ...
 * File: empty_state_view.h - Empty state placeholder widget
 */
...
/**
 * @brief Empty state placeholder widget
 *
 * A custom UI widget providing empty state placeholder widget.
...
public:
    /**
     * @brief Construct the EmptyStateView widget
