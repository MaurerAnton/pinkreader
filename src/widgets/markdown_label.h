 ...
 * File: markdown_label.h - Markdown rendered text label
 */
...
/**
 * @brief Markdown rendered text label
 *
 * A custom UI widget providing markdown rendered text label.
...
public:
    /**
     * @brief Construct the MarkdownLabel widget
