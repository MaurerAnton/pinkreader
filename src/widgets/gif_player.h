 ...
 * File: gif_player.h - GIF animation playback widget
 */
...
/**
 * @brief GIF animation playback widget
 *
 * A custom UI widget providing gif animation playback widget.
...
public:
    /**
     * @brief Construct the GifPlayer widget
