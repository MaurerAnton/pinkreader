 ...
 * File: video_player.h - Video playback widget with controls
 */
...
/**
 * @brief Video playback widget with controls
 *
 * A custom UI widget providing video playback widget with controls.
...
public:
    /**
     * @brief Construct the VideoPlayer widget
