 ...
 * File: score_widget.h - Vote score display with animation
 */
...
/**
 * @brief Vote score display with animation
 *
 * A custom UI widget providing vote score display with animation.
...
public:
    /**
     * @brief Construct the ScoreWidget widget
