 ...
 * File: thumbnail_view.cpp - Implementation of Image thumbnail loading widget
 */

#include "widgets/thumbnail_view.h"
...
ThumbnailView::ThumbnailView(QWidget *parent)
    : QWidget(parent)
{
    Logging::debug("Widgets::ThumbnailView", "Creating widget...");
    ...
    Logging::debug("Widgets::ThumbnailView", "Widget created");
}

ThumbnailView::~ThumbnailView()
{
    Logging::debug("Widgets::ThumbnailView", "Widget destroyed");
...
qreal ThumbnailView::opacity() const
{
    return m_opacity;
}

void ThumbnailView::setOpacity(qreal opacity)
{
...
QColor ThumbnailView::backgroundColor() const
{
...
int ThumbnailView::animationDuration() const
{
    return m_animationDuration;
}

void ThumbnailView::setAnimationDuration(int ms)
{
...
bool ThumbnailView::isLoading() const
{
    return m_isLoading;
}

void ThumbnailView::showLoading()
{
    if (m_isLoading) return;

    Logging::debug("Widgets::ThumbnailView", "Showing loading state");
    m_isLoading = true;
    update();
}

void ThumbnailView::hideLoading()
{
    if (!m_isLoading) return;

    Logging::debug("Widgets::ThumbnailView", "Hiding loading state");
    m_isLoading = false;
    update();
}

bool ThumbnailView::isInteractionEnabled() const
{
    return m_isEnabled;
}

void ThumbnailView::setInteractionEnabled(bool enabled)
{
    m_isEnabled = enabled;
    setEnabled(enabled);
    update();
...
void ThumbnailView::setText(const QString &text)
{
...
QString ThumbnailView::text() const
{
    return m_text;
}

void ThumbnailView::setSubtitle(const QString &subtitle)
{
...
void ThumbnailView::setIcon(const QIcon &icon)
{
    m_icon = icon;
    if (m_iconLabel) {
...
void ThumbnailView::setupUi()
{
    Logging::debug("Widgets::ThumbnailView", "Setting up UI...");
    ...
    m_textLabel->setObjectName(QStringLiteral("ThumbnailViewText"));
    ...
    m_subtitleLabel->setObjectName(QStringLiteral("ThumbnailViewSubtitle"));
    ...
    m_iconLabel->setObjectName(QStringLiteral("ThumbnailViewIcon"));
    m_iconLabel->setFixedSize(24, 24);
    m_iconLabel->setAlignment(Qt::AlignCenter);

    // Image label
    m_imageLabel = new QLabel(this);
    m_imageLabel->setObjectName(QStringLiteral("ThumbnailViewImage"));
...
void ThumbnailView::connectSignals()
{
    Logging::debug("Widgets::ThumbnailView", "Connecting signals...");

    // Theme change handling
    connect(&ThemeManager::instance(), &ThemeManager::themeApplied,
            this, &ThumbnailView::applyTheme);
...
void ThumbnailView::animateOpacity(qreal targetOpacity)
{
