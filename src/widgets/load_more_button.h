 ...
 * File: load_more_button.h - Load more content button
 */
...
/**
 * @brief Load more content button
 *
 * A custom UI widget providing load more content button.
...
public:
    /**
     * @brief Construct the LoadMoreButton widget
