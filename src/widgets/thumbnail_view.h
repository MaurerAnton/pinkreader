 ...
 * File: thumbnail_view.h - Image thumbnail loading widget
 */
...
/**
 * @brief Image thumbnail loading widget
 *
 * A custom UI widget providing image thumbnail loading widget.
...
public:
    /**
     * @brief Construct the ThumbnailView widget
