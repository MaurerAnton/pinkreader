 ...
 * File: bottom_toolbar.h - Bottom action toolbar
 */
...
/**
 * @brief Bottom action toolbar
 *
 * A custom UI widget providing bottom action toolbar.
...
public:
    /**
     * @brief Construct the BottomToolbar widget
