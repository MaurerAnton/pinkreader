 ...
 * File: error_view.h - Error state display widget
 */
...
/**
 * @brief Error state display widget
 *
 * A custom UI widget providing error state display widget.
...
public:
    /**
     * @brief Construct the ErrorView widget
     * @param parent Parent widget (nullptr for top-level)
     */
    explicit ErrorView(QWidget *parent = nullptr);
