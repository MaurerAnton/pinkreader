 ...
 * File: progress_bar.h - Determinate progress bar
 */
...
/**
 * @brief Determinate progress bar
 *
 * A custom UI widget providing determinate progress bar.
...
public:
    /**
     * @brief Construct the ProgressBar widget
