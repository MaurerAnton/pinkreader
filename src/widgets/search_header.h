 ...
 * File: search_header.h - Search results header widget
 */
...
/**
 * @brief Search results header widget
 *
 * A custom UI widget providing search results header widget.
 * Designed for optimal performance on mobile devices with
 * smooth animations, gesture support, and accessibility features.
 */
class SearchHeader : public QWidget
{
    Q_OBJECT
...
public:
    /**
     * @brief Construct the SearchHeader widget
     * @param parent Parent widget (nullptr for top-level)
     */
    explicit SearchHeader(QWidget *parent = nullptr);
