 ...
 * File: announcement_banner.h - Developer announcement banner
 */
...
/**
 * @brief Developer announcement banner
 *
 * A custom UI widget providing developer announcement banner.
...
public:
    /**
     * @brief Construct the AnnouncementBanner widget
