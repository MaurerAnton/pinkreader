 ...
 * File: comment_widget.h - Comment rendering widget
 */
...
/**
 * @brief Comment rendering widget
 *
 * A custom UI widget providing comment rendering widget.
...
public:
    /**
     * @brief Construct the CommentWidget widget
