 ...
 * File: linkified_label.h - Auto-link detection text label
 */
...
/**
 * @brief Auto-link detection text label
 *
 * A custom UI widget providing auto-link detection text label.
 * Designed for optimal performance on mobile devices with
 * smooth animations, gesture support, and accessibility features.
 */
class LinkifiedLabel : public QWidget
{
    Q_OBJECT
...
public:
    /**
     * @brief Construct the LinkifiedLabel widget
     * @param parent Parent widget (nullptr for top-level)
     */
    explicit LinkifiedLabel(QWidget *parent = nullptr);

    /**
     * @brief Destructor
     */
    ~LinkifiedLabel() override;
