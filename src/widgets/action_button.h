 ...
 * File: action_button.h - Custom action button with icon and label
 */
...
/**
 * @brief Custom action button with icon and label
 *
 * A custom UI widget providing custom action button with icon and label.
...
public:
    /**
     * @brief Construct the ActionButton widget
