 ...
 * File: post_card.h - Post card widget for post listings
 */
...
/**
 * @brief Post card widget for post listings
 *
 * A custom UI widget providing post card widget for post listings.
...
public:
    /**
     * @brief Construct the PostCard widget
