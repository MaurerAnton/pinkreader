 ...
 * File: tab_bar.h - Tab navigation bar widget
 */
...
/**
 * @brief Tab navigation bar widget
 *
 * A custom UI widget providing tab navigation bar widget.
...
public:
    /**
     * @brief Construct the TabBar widget
