 ...
 * GPLv3 License
 * File: cache_compression.h - Zstd compression for cached data
 */
...
class CacheCompression : public QObject
{
    Q_OBJECT

public:
    explicit CacheCompression(QObject *parent = nullptr);
    ~CacheCompression() override;
