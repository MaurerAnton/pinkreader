 ...
 * GPLv3 License
 * File: cache_pruner.h - Background cache cleanup and pruning
 */
...
class CachePruner : public QObject
{
    Q_OBJECT

public:
    explicit CachePruner(QObject *parent = nullptr);
    ~CachePruner() override;
