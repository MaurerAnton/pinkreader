/*
 * PinkReader - GPLv3
 * File: inbox_adapter.h - Inbox message list adapter
 */
...
class InboxAdapter : public QAbstractListModel
{
    Q_OBJECT
...
public:
    ...
    explicit InboxAdapter(QObject *parent = nullptr);
    ~InboxAdapter() override;
