/*
 * PinkReader - GPLv3
 * File: comment_list_adapter.h - Comment list data adapter
 */
...
class CommentListAdapter : public QAbstractListModel
{
    Q_OBJECT
...
public:
    ...
    explicit CommentListAdapter(QObject *parent = nullptr);
    ~CommentListAdapter() override;
