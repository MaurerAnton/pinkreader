/*
 * PinkReader - GPLv3
 * File: user_list_adapter.h - User profile list adapter
 */
...
class UserListAdapter : public QAbstractListModel
{
    Q_OBJECT
...
public:
    ...
    explicit UserListAdapter(QObject *parent = nullptr);
    ~UserListAdapter() override;
