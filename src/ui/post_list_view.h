 ...
 * GPLv3 License
 * File: post_list_view.h - Post listing and browsing view
 */
...
/**
 * @brief Post listing and browsing view
 */
...
public:
    explicit PostListView(QWidget *parent = nullptr);
    ~PostListView() override;
